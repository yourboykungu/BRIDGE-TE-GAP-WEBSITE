export default function Card({ title, imageUrl, body }) {
    return (
      <div className='h-84'>
        <div className='w-64 h-full border rounded-lg shadow-xl hover:animate-pulseOnce transition duration-300 hover:shadow-lg overflow-hidden'>
          <div>
          ...
          <div className='flex flex-col m-2 gap-1 h-full'>
            ...
            <div className='flex-shrink-0'>
              <button className='border border-black rounded-lg w-full overflow-visible'>
                <a href="#" className='block text-center no-underline'>view website</a>
              </button>
            </div>
          </div>
        </div>
